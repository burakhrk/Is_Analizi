...
const IS_ANALIZI_SORULARI = [
    {
        ...
        sorular: [
            ...
            { id: "fazla_mesai", etiket: "Fazla mesai süresi ve sıklığı", tip: "textarea" },
            { id: "nobet", etiket: "Nöbet süresi ve sıklığı", tip: "textarea" },
    ...
    },
    {
        ...
        sorular: [
            ...
            { id: "imza_ad", etiket: "İmza (Ad Soyad)", tip: "text" }
        ]
    }
];
